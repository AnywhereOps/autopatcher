# Downloaded from https://github.com/autopkg/gerardkok-recipes/blob/fba95dd24e8408ba08f9d74cb5f82468883691fa/DotNet/DotNetURLProvider.py
# Commit: fba95dd24e8408ba08f9d74cb5f82468883691fa
# Downloaded at: 2025-11-27 22:28:10 UTC
...
class DotNetURLProvider(URLGetter):
    ...
    input_variables = {
        ...
        "language_code": {"required": False, "description": "Language code to use in urls", "default": "en-us"},
    }
    output_variables = {
        "release_url": {
